        ...
        children: <Widget>[
          DefaultTextStyle(
            ...
            child: Text(
              ...
              style: getDayStyle(isSelectable, index, isSelectedDay, isToday, isPrevMonthDay, isPrevMonth, textStyle,
    ...
    return isSelectedDay && widget.selectedDayTextStyle != null
        ...
        : isMultipleMarked
            ...
            : (_localeDate.dateSymbols.WEEKENDRANGE.contains((index - 1 + firstDayOfWeek) % 7)) &&
                    ...
                    !isToday
                ? (isSelectable
                    ? (isBeforeToday || isPrevMonth) && widget.weekendAlternativeTextStyle != null
